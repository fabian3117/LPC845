 ...
 *
 * @file		usart.h
 * @brief		Clase base de la comunicacion Asincronica
 * @date		5 oct. 2022
...
#ifndef I1_USART_COMUNICACIONASINCRONICA_H_
#define I1_USART_COMUNICACIONASINCRONICA_H_
...
#endif /* I1_USART_COMUNICACIONASINCRONICA_H_ */
